...
This library is a fork of the original WooCommerce REST API JavaScript Library, enhanced with updated packages by [Giovani Franz](https://github.com/giovanifranz/).

## Installation

```bash
npm install @highlandertech/woocommerce-rest-api
```
